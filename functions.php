...
if( ! function_exists( 'reverie_theme_support' ) ) {
    function reverie_theme_support() {
        ...
        register_nav_menus(array(
            ...
            'footer1' => __('footer1', 'reverie'),
	    'footer2' => __('footer2', 'reverie'),
	    'footer3' => __('footer3', 'reverie')
        ));
...
function auto_login_new_user( $user_id ) {
	    ...
	    if ( current_user_can('read_private_posts') ) {
		     wp_redirect( 'http://www.strategyandfield.com/firstproject' );
		}
		else {
		    wp_redirect( 'http://www.strategyandfield.com/completeprofile' );
		}
...
function add_buttons() {
    echo '<p class="text-center"><a class="jbp-shortcode-button jbp-browse-job dark" href="http://www.strategyandfield.com/job/">
			Browse Jobs
		</a><a class="jbp-shortcode-button jbp-browse-pro dark" href="http://www.strategyandfield.com/expert/">
			Browse Experts
		</a><a class="jbp-shortcode-button jbp-add-job dark" href="http://www.strategyandfield.com/add-a-job/">
			Post a Job
		</a><a class="jbp-shortcode-button jbp-list-job dark" href="http://www.strategyandfield.com/my-jobs/">
			My Jobs
		</a><a class="ig-container jbp-shortcode-button jbp-message-inbox dark" href="http://www.strategyandfield.com/inbox/">
			<i style="display: block" class="fa fa-inbox fa-2x"></i>Inbox
		</a></p>';
}
